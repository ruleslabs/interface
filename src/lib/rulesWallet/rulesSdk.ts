import { constants, RulesSdk } from '@rulesorg/sdk-core'

const STARKNET_NETWORK_NAME = process.env.REACT_APP_STARKNET_NETWORK_NAME as any
if (
  !STARKNET_NETWORK_NAME ||
  !Object.values(constants.StarknetNetworkName).includes(STARKNET_NETWORK_NAME as constants.StarknetNetworkName)
) {
